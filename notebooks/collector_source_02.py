...
transform["address_composed"] = (
    transform["address.streetNumber"].astype(str)
    + ", "
    + transform["address.streetAddress"].astype(str)
    + ", "
    + transform["address.addressLocality"].astype(str)
    + ", "
    + transform["address.postalCode"].astype(str)
    + ", "
    + transform["address.addressCountry"].astype(str)
)
