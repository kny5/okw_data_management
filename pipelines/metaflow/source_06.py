...
class Source_06(FlowSpec, TailSteps):
    ...
    def clean(self):
        ...
        self.data_input["record_source_url"] = self.data_input["record_source_url"].str[
            :-5
        ]
    ...
    def enrich(self):
        ...
        print(
            f"New columns added: {[c for c in self.data_input.columns if c in ['materials','processes','machines','products','works_with']]}"
        )
